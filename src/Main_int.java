...
public class Main_int {
	...
	public static void main(String[] args) {
		...
		Main_int main_int = new Main_int();
		main_int.actions(list);
	}
	...
	public void actions(OneWayLinkedListWithHead list)
	{
		...
		do
		{
			...
			case 15:
			{
				...
				Element<Integer> e = new Element<Integer>(tmp);
			...
			case 16:
			{
				...
				IList<Integer> newList = list.reverseCreate();
				IList<Integer> other = list.merge(newList, append);
			...
			case 17:
			{
				...
				IList<Integer> sublist = new OneWayLinkedListWithHead<Integer>();
